...
const mockProduct = {
  id: 'p1', name: 'Producto Test', priceCents: 1999, currency: 'USD', imageUrl: 'https://img', imageAlt: 'Producto Test', category: 'action-figures', stock: 10, rating: 4.5, reviewCount: 100,
};
...
describe('ProductCard', () => {
  ...
  it('renderiza rating y reviewCount', () => { render(<ProductCard {...mockProduct} />); expect(screen.getByText('4.5')).toBeInTheDocument(); expect(screen.getByText('(100 reseñas)')).toBeInTheDocument(); });
