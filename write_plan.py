...
import pathlib  
p = pathlib.Path('.kilo/plans/1786724547484-firestore-index-category-fix.md')  
content = chr(10).join([  
...
'  '',  
'  El usuario debe abrir el link que aparece en el error:',  
'  ',  
'  https://console.firebase.google.com/v1/r/project/e-commerce-project5/firestore/indexes?create_composite=...',  
'  ',  
'  O crear el indice manualmente en Firebase Console:',  
'  - Coleccion: products',  
...
'  ])  
p.write_text(chr(10).join(content), encoding='utf-8')  
print('Plan saved')  
